...
app.post(
  ...
  asyncHandler(async (req, res) => {
    const { email, birthDate } = req.body as { email?: string; birthDate?: string };
    if (!email) {
...
async function addDirectoryToZip(zip: AdmZip, absoluteDir: string, relativeDir: string) {
